...
// Fungsi pencarian
const search = () => {
    formSearch.get(route("md.units.index"), {
...
const deleteData = (e: Event) => {
    ...
    form.delete(route('md.units.destroy', `${confirmingDeletionid.value}`), {
        preserveScroll: true,
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <div class="px-4 py-6">
            ...
            <div class="flex items-center mb-6">
                <Link :href="route('md.units.create')"
                            ...
                            <tr v-for="unit in units.data" v-bind:key="unit.id">
                                ...
                                <td class="px-4 py-2 whitespace-nowrap w-20">
                                    <span
                                        ...
                                        <Link :href="route('md.units.edit', unit.id)"
                                        ...
                                        <button @click.prevent="() => confirmDeletion(unit.id)" method="delete"
