...
// Fungsi pencarian
const search = () => {
    formSearch.get(route("md.customers.index"), {
...
const deleteData = (e: Event) => {
    ...
    form.delete(route('md.customers.destroy', `${confirmingDeletionid.value}`), {
        preserveScroll: true,
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <div class="px-4 py-6">
            ...
            <div class="flex items-center mb-6">
                <Link :href="route('md.customers.create')"
                            ...
                            <tr v-for="customer in customers.data" v-bind:key="customer.id">
                                ...
                                <td class="px-4 py-2 whitespace-nowrap w-20">
                                    <span
                                        ...
                                        <Link :href="route('md.customers.edit', customer.id)"
                                        ...
                                        <button @click.prevent="() => confirmDeletion(customer.id)" method="delete"
