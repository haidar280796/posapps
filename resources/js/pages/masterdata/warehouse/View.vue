...
import { type BreadcrumbItem, type Product, type Warehouse } from '@/types';
...
const breadcrumbs: BreadcrumbItem[] = [
    {
        title: 'Warehouses',
        href: route('md.warehouses.index'),
    },
];
...
// Fungsi pencarian
const search = () => {
    formSearch.get(route("md.warehouses.index"), {
...
const deleteData = (e: Event) => {
    ...
    formDelete.delete(route('md.warehouses.destroy', `${confirmingDeletionid.value}`), {
        preserveScroll: true,
...
<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <div class="px-4 py-6">
            <Heading title="Master Data Warehouses" description="Manage your master data warehouses" />

            <div class="flex items-center mb-6">
                <Link :href="route('md.warehouses.create')"
            ...
            <div class="overflow-x-auto">
                <table
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <template v-else>
                            <tr v-for="warehouse in warehouses.data" v-bind:key="warehouse.id">
                                ...
                                <td class="px-4 py-2 whitespace-nowrap w-20">
                                    <span
                                        ...
                                        <Link :href="route('md.warehouses.edit', warehouse.id)"
                                        ...
                                        <button @click.prevent="() => confirmDeletion(warehouse.id)" method="delete"
            ...
            <div class="py-2 mt-4">
                <ol class="flex justify-end gap-1 text-xs font-medium">
                    <template v-for="(link, index) in warehouses.links" :key="index">
                        <li>
